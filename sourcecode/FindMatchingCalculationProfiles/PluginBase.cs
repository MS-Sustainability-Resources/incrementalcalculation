...
namespace Microsoft.Dynamics.Sustainability.Plugins
{
    ...
    public abstract class PluginBase : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            context.Trace($"Entered {PluginClassName}.Execute() " +
                $"Correlation Id: {context.PluginExecutionContext.CorrelationId}, " +
                $"Initiating User: {context.PluginExecutionContext.InitiatingUserId}");

            try
            {
                // Invoke the plugin implementation implementation 
                ExecuteCrmPlugin(context).GetAwaiter().GetResult();
        ...
        public abstract System.Threading.Tasks.Task ExecuteCrmPlugin(IPluginContext localPluginContext);
    }
    ...
    public class PluginContext : IPluginContext
    {
        ...
        public PluginContext(IServiceProvider serviceProvider)
        {
            ...
            TracingService = new TracingService(serviceProvider);
            ...
            OrganizationService = serviceProvider.GetOrganizationService(PluginExecutionContext.InitiatingUserId); //User who's action called the plugin.
